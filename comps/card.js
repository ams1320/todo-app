...
import { deleteTask, editTask, doneTask, loadTasks } from '@/redux/taskReducer';
                        ...
                        !tasks ? <Typography variant='h4'>nothing here</Typography> :
                            tasks.map((task, index) => {
                                return (
                                    type == undefined ?
                                        (
                                            <Grid item={task.name} sm={6} xs={12} mb={2} sx={{ display: hideTask && task.done ? "none" : "block", marginLeft: { sm: 0, xs: 5 }, right: 0 }}>
                                                <Card sx={{ maxWidth: 460, opacity: task.done ? .6 : 1, }} className={Style.card}>
                                                    <CardContent>
                                                        <Stack direction='row' justifyContent="space-between">
                                                            ...
                                                            <Box class="modal fade" id={`staticBackdrop${index}`} data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <Typography variant='h2' class="modal-title fs-5" id="staticBackdropLabel">Modal title</Typography>
                                                                                    ...
                                                                                    <Form style={{}} onSubmit={formikBag.handleSubmit} className="form-container">
                                                                                        <Grid container mr={1}>
                                                                                            <Grid sm={12} xs={12} mb={2} mt={2}>
                                                                                                <Field as="select" name="type" className={Style.cardOptionGroup} >
                                                        ...
                                                        <Typography variant='h5' className={Style.cardInfo}>{task.info}</Typography>
                                                    </CardContent>
